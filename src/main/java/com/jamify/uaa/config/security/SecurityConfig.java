...
import com.jamify.uaa.service.impl.JpaOAuth2AuthorizedClientService;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http, CustomOAuth2UserService customOAuth2UserService, JwtAuthenticationFilter jwtAuthenticationFilter, UserService userService, OAuth2AuthorizedClientService authorizedClientService, UaaRefreshTokenService uaaRefreshTokenService) throws Exception {
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        .requestMatchers("/", "/auth/**", "/login/**", "/oauth2/**", "/api/v1/oauth/.well-known/jwks.json").permitAll()
    ...
    public OAuth2AuthorizedClientService authorizedClientService(
            ...
            com.jamify.uaa.repository.OAuth2AuthorizedClientRepository repository) {
        return new JpaOAuth2AuthorizedClientService(repository, clientRegistrationRepository);
    }
